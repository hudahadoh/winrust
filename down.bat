@echo off
curl -L -o login.py https://raw.githubusercontent.com/hudahadoh/winrust/main/login.py
curl -L -o loop.bat https://raw.githubusercontent.com/hudahadoh/winrust/main/loop.bat
curl -L -o show.bat https://raw.githubusercontent.com/hudahadoh/winrust/main/show.bat
